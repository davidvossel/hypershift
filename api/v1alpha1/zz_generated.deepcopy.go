...
func (in *KubevirtRootVolume) DeepCopyInto(out *KubevirtRootVolume) {
	*out = *in
	...
	in.KubevirtVolumeTypes.DeepCopyInto(&out.KubevirtVolumeTypes)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubevirtVolumeTypes) DeepCopyInto(out *KubevirtVolumeTypes) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubevirtVolumeTypes.
func (in *KubevirtVolumeTypes) DeepCopy() *KubevirtVolumeTypes {
	if in == nil {
		return nil
	}
	out := new(KubevirtVolumeTypes)
	in.DeepCopyInto(out)
	return out
}
